...
function handler() {
    ...
    useEffect(() => {
        ...
        t(block3.current, 0.6, '-5px')
        t(block4.current, 0.6, '-5px')
        t(block5.current, 0.6, '-5px')
        t(block6.current, 0.6, '-5px')
                    ...
                    <main className="main">
                        <div className="section">
                            ...
                            <div className="container">
                                <h1 className="do-anim appear-slideInUp forAnimation" ref={block4} style={{ fontWeight: 'bold' }} ><span
                                    className="highlight">OOPS</span>! You used the wrong referral link</h1>
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    <img src="/ref/alert.png" style={{ maxWidth: "256px;" }} />
                                </div>
                                <div className="section-actions do-anim appear-slideInUp forAnimation" ref={block3} style={{ marginTop: "71px;", fontWeight: 'bold' }} id="invite-more">
                                    <h3 style={{ fontWeight: 'bold' }} >To get the real link we recommend you to join Frogs Community and ask a valid link</h3>
                                    <a href="https://t.me/frogsfi" className="button button--big">Join Community</a>
                                </div>
                            </div>
