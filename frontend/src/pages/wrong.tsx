    ...
    useEffect(() => {
        const t = (el: any, duration?: number, px?: string, start?: string) => {
            gsap.to(el, {
                scrollTrigger: {
                    trigger: el,
                    start: start == undefined ? 'top bottom' : start
                },
        ...
        t(block1.current, 0.8)
        t(block2.current, 0.8)
        t(block3.current, 0.8)
        t(block4.current, 0.8)
        ...
        <div>
            <div className="change-background">
                <div className="wrap">
                    ...
                    <main className="main">
                        <div className="section" style={{ paddingBottom: '52px' }}>
                            ...
                            <div className="container" style={{ paddingTop: "40px", zIndex: 100 }}>
                                ...
                                <div style={{ display: " flex", justifyContent: "center" }}>
                                    <img src="/ref/alert.png" style={{ maxWidth: "256px", marginTop: '-40px', zIndex: '10000' }} />
                                </div>
                                <div style={{ marginTop: "90px" }} className="section-actions do-anim appear-slideInUp forAnimation" ref={block3} id="invite-more">
                            ...
                            {/* <div className="container" >
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '-40px' }} >
                                    <img src="/ref/alert.png" style={{ maxWidth: "256px;" }} />
                                </div>
                                <div className="section-actions do-anim appear-slideInUp forAnimation" ref={block3} id="invite-more">
                                    <h3  >To get the real link we recommend you to join <br /> Frogs Community and ask a valid link</h3>
                                    <a href="https://t.me/frogsfi" className="button button--big" style={{ maxWidth: '560px' }}>Join Community</a>
                                </div>
                            </div>*/}
                    ...
                    <footer className="footer" style={{ paddingBottom: '80px' }}>
                        <div className="container">
                            <div className="footer__top  do-anim appear-slideInUp">
                            ...
                            <div className="footer__bottom do-anim appear-slideInUp">
