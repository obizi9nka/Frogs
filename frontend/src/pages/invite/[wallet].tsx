...
function handler({ referer }: any) {
    ...
    const connectWallet = async (address: any) => {
        try {
            createUser(address)
        } catch (error) {
            console.log(error)
    ...
    useEffect(() => {
        ...
        t(block1.current, 0.4)
        t(block2.current, 0.75)
        t(block3.current, 0.3)
        t(block4.current, 0.6)
        t(block5.current, 0.9)
        t(block6.current)
        t(blockFrog2.current, 1)
        t(blockFrog1.current, 1.2)
        t(blockFooter1.current, 0.6, undefined, '-15px', 'top bottom')
        t(blockFooter2.current, 0.6, undefined, '-15px', 'top bottom')
        t(block9.current)
        t(block10.current)
            ...
            <div className="wrap">
                    ...
                    <div className="section" >
                        ...
                        <div className="container" >
                            ...
                            <ul className="roadmap do-anim appear-slideInUp forAnimation" ref={block2}>
                                ...
                                <li className="roadmap__item">
                                    <h4 >Smart Contract deployed<br /> on Main Net</h4>
                                    <p>(Check <a href="">GitHub</a> & <a href="">Gitbook</a>)</p>
                                    <div className="roadmap__item-dot done"></div>
                                </li>
                                <li className="roadmap__item">
                                    <h4 >Partnership with<br /> BNB Chain</h4>
                                    <div className="roadmap__item-dot done"></div>
                                </li>
                                <li className="roadmap__item">
                                    <h4 >AIRDROP 1.0</h4>
                                ...
                                <li className="roadmap__item">
                                    <h4 >Beta Product is Live</h4>
                                    <div className="roadmap__item-dot"></div>
                                </li>
                                <li className="roadmap__item">
                                    <h4 >$FROGS is listed</h4>
                                    <div className="roadmap__item-dot"></div>
                                </li>
                            </ul>
                    ...
                    <div className="section section--small" >
                        ...
                        <div className="container">
                            ...
                            <div className="services" >
                                ...
                                >GitHub</a>
                                <a href="https://frogs.gitbook.io/frogsfi" className="services__item color-gitlook do-anim forAnimation" ref={blockGitBook}
                                >Gitbook</a>
                        ...
                        <div className="container" >
                            <div className="box do-anim appear-slideInUp forAnimation" ref={block6}>
                                ...
                                <div className="section-actions">
                                    <div onClick={connectWallet} className="button button--big" style={{ maxWidth: '560px', marginRight: 'auto', marginLeft: 'auto' }}>Connect Wallet</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <footer className="footer" style={{ padding: '80px 0px 80px 0px' }}>
                    <div className="container">
                        ...
                        <div className="footer-line" style={{ height: '0.5px' }}></div>
                        <div className="footer__bottom do-anim appear-slideInUp forAnimation" ref={blockFooter2} style={{ paddingTop: '0px' }}>
