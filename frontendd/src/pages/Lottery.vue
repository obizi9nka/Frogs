  ...
  <div>
    ...
    <div class="container">
            ...
            <div class="pool__body">
              <div class="pool__token">
                ...
                <div class="pool__token__footer">
                  <div class="pool__token__estimate">~<span>{{ form.deposit.cake * pancake.rates.cakeusdt }}</span> USD</div>
              ...
              <div class="pool__token">
                ...
                <div class="pool__token__footer">
                  <div class="pool__token__estimate">~<span>{{ form.deposit.bnb * pancake.rates.bnbusdt }}</span> USD</div>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><small>{{ frog.user.deposit * (pancake.rates.lpcake * pancake.rates.cakeusdt + pancake.rates.lpbnb * pancake.rates.bnbusdt ) }}</small></td>
                </tr>
                <tr>
                  <td>balance</td>
                  ...
                  <td><small>{{ frog.user.balance * (pancake.rates.lpcake * pancake.rates.cakeusdt + pancake.rates.lpbnb * pancake.rates.bnbusdt ) }}</small></td>
                </tr>
                <tr>
                  <td>withdraw</td>
                  ...
                  <td><small>{{ frog.user.withdraw * (pancake.rates.lpcake * pancake.rates.cakeusdt + pancake.rates.lpbnb * pancake.rates.bnbusdt ) }}</small></td>
                </tr>
              </table>
              <div>
              ...
              <br>
              <div><h3>Last Draw Number: {{ frog.drawNumber }}</h3> </div>
              <div><h3>Total Farm: {{ frog.farmTotal }}</h3> </div>
              <div><h3>Your Reward: {{ frog.user.reward }}</h3> </div>
      ...
      <div>
        ...
        <form @submit.prevent class="admin-form" v-if="isOwner">
          <input-text
              v-model="form.newFeePercent"
              placeholder="New Fee Percent"
              class="input"
          />
...
export default {
  ...
  methods: {
    async updateParams(){
      ...
      this.pancake.rates.cakebnb = supply / reserves._reserve1;
    ...
    async deposit(){
      ...
      if(errors.length){
        ...
        if(confirm("You want to send: \n"+this.form.deposit.cake+" CAKE\n"+this.form.deposit.bnb+" BNB")) {
          ...
          console.log('CAKE: '+amountToken0)
          console.log('BNB: '+amountToken1)
