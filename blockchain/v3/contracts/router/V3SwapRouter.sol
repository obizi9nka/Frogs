...
abstract contract V3SwapRouter is IV3SwapRouter, PeripheryPaymentsWithFeeExtended, OracleSlippage, ReentrancyGuard {
    ...
    function pancakeV3SwapCallback(
        ...
        console.log(uint(amount0Delta), uint(amount1Delta));
        require(amount0Delta > 0 || amount1Delta > 0, 'delta in router'); // swaps entirely within 0-liquidity regions are not supported
        SwapCallbackData memory data = abi.decode(_data, (SwapCallbackData));
        (address tokenIn, address tokenOut, uint24 fee) = data.path.decodeFirstPool();
        SmartRouterHelper.verifyCallback(factory, tokenIn, tokenOut, fee); // deployer
    ...
    function exactInputInternal(
        ...
        console.log("exactOutputInternal swap start");
        ...
        console.log("exactOutputInternal swaped");
